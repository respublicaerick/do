    ...
    <section>
            ...
            <div class="column is-one-third">
                <div class="box">
                    <p class="title is-4 has-text-grey ">
                        ...
                        Ventas por hora
                        <span class="tag personalizado is-large is-pulled-right" style="background-color: orange;"> {{totalVentasHora}}Bs.</span>
            ...
            <div class="column is-one-third">
                <div class="box">
                    <p class="title is-4 has-text-grey ">
                        ...
                        Ventas de usuarios
                        <span class="tag personalizado is-large is-pulled-right" style="background-color: orange;"> {{totalVentasUsuarios}}Bs.</span>
                    </p>
                    <b-field label="Selecciona un periodo de tiempo">
                        <b-datepicker
                            placeholder="Click para seleccionar..."
            ...
            <div class="column is-one-third">
                <div class="box">
                    <p class="title is-4 has-text-grey ">
                        ...
                        Ventas por semana
                        <span class="tag personalizado is-large is-pulled-right" style="background-color: orange;"> {{totalVentasSemana}}Bs.</span>
                    </p>
        ...
        <div class="box">
            <p class="title is-4 has-text-grey ">
                ...
                Ventas por año 
                <span class="tag personalizado is-large is-pulled-right" style="background-color: orange;"> {{totalVentasMeses}}Bs.</span>
...
export default ({
    ...
    methods: {
        ...
        obtenerDatos(){
            this.cargando = true
            HttpService.registrar(this.filtros, "inicio.php")
            .then(resultado => { 
                ...
                this.cartas = [
                    {
                        ...
                        titulo: "Ventas hoy",
                        total: "Bs." + this.resultadoCartas.totalVentasDia,
                        icono: "cart-outline",
                    ...
                    },
                    {
                        ...
                        titulo: "Ventas",
                        total: "Bs." + this.resultadoCartas.totalVentas,
                        icono: "cart-outline",
